...
| URL | 用途 |
|-----|------|
| http://127.0.0.1:8000/ | フロントエンド |
| http://127.0.0.1:8000/admin/ | Django管理画面 |
...
1. http://127.0.0.1:8000/admin/ にログイン
2. 「パートナー」→「パートナーを追加」
   - 会社名、メールアドレスを入力して保存
...
1. http://127.0.0.1:8000/admin/core/customer/ を開く
...
1. 管理者でログイン → http://127.0.0.1:8000/
